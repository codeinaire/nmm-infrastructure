...
#  !___ USER POOL AUTHENTICATION ___! #
# Federation -
# Identity providers
# This is some further set-up to do: https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-social-idp.html
...
# This is not needed for basic setup of authorization
# resource "aws_cognito_user_group" "no_meat_may" {
#   name         = "user-group"
#   user_pool_id = "${aws_cognito_user_pool.no_meat_may.id}"
#   description  = "A group to give users access to API Gateway"
#   precedence   = 42
...
#  !___ COGNITO IDENTITY POOL AUTHENTICATION ___ #
